...
export const playWonderNarration = (step) => {
  if (step === 0) {
    return [
      say("Sarah opens her book just a little bit. Then Mike opens his book all the way flat."),
      ask("Whose book makes a bigger angle? Think about it!")
    ];
  }
  return [
...
export const playStoryNarration = (panelIdx) => {
  switch (panelIdx) {
    case 0:
      return [
        say("John lands in Paris, France."),
